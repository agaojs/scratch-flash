...
package ui.parts {
	...
	public class TopBarPart extends UIPart {
		...
		protected var submitButton:IconButton;
		...
		protected function addButtons():void {
			...
			if (Scratch.app.isExtensionDevMode) {
				...
				submitButton = new IconButton(app.submitProject, Resources.createBmp('submit'))
				submitButton.visible = false;
				addChild(submitButton);
				submitButton.scaleX = submitButton.scaleY = 1;
				scale = desiredButtonHeight / submitButton.height;
				submitButton.scaleX = submitButton.scaleY = scale;
		...
		protected function fixLayout():void {
			...
			submitButton.x = nextX;
			submitButton.y = buttonY;
			nextX += submitButton.width + buttonSpace;
